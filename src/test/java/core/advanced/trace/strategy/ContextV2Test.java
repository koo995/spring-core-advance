...
import core.advanced.trace.strategy.code.strategy.ContextV2;
...
public class ContextV2Test {
    ...
    /**
     * 전략 패턴 익명 내부 클래스를 사용하는 경우
     * execute 에서 실행할 코드 조각을 넘긴다고 생각
     */
    @Test
    void strategyV2() {
        ContextV2 context = new ContextV2();
    ...
    /**
     * 전략 패턴 익명 내부 클래스를 람다식으로 변경
     * 진짜로 코드 조각을 넘기는 듯한 방식..
     */
    @Test
    void strategyV3() {
        ContextV2 context = new ContextV2();
